...
input       MACRO  inPrompt, boundary, inStr, maxLength     ; prompt for and input  string
            pushad                     ; save general registers
			...
			lea    ebx, boundary	   ; boundary address
			push   ebx				   ; boundary parameter on stack
